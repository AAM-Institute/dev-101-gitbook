...
**Welcome to Web Dev (continued):** https://www.youtube.com/watch?v=88QJumITbQA (5 min)

I suggest students open a new Codepen instance and follow along with parts of the following tutorial: https://codepen.io/pen
...
**Your first web page**: https://www.youtube.com/watch?v=88QJumITbQA (5 min)
This features a Live Reload plugin for VSCode, this may be a good tool to use!
